...
* Если код тренировки неопределен, то возвращает строку с ошибкой.
...
def main(training)
```
Функция `main()` должна принимать на вход экземпляр класса `Training`, или строку с ошибкой.

– При получении строки с ошибкой, она тут же выводится в функцию `print()`. 
